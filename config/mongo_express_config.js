...
//TODO JMC db name and other options
if (config.mongodb || config.mongodbTest) {
    mongo = {
        db: 'heliosdb',
        host: 'localhost',
    ...
    logger.info("connected to failsafe local database.");  
}
...
module.exports = {
    mongodb: {
        ...
        adminUsername: process.env.ME_CONFIG_MONGODB_ADMINUSERNAME || config.mongo_express.adminUsername,
        adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || config.mongo_express.adminPassword,
    ...
    site: {
        ...
        port: process.env.VCAP_APP_PORT || config.mongo_express.site.port,
    ...
    basicAuth: {
        username: process.env.ME_CONFIG_BASICAUTH_USERNAME || config.mongo_express.basicAuth.username,
        password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || config.mongo_express.basicAuth.password,
    },
